...
export default class Sae extends BaseInput {
  ...
  render() {
    ...
    const showAnimate = isBottomBorder !== false;
      ...
      >
        ...
        <AnimatedIcon
          ...
          style={{
            ...
            fontSize: iconSize ? iconSize : 20,
            backgroundColor: 'transparent',
          }}
        />
        {/* bottom border */}
        { showAnimate ? (<Animated.View
              style={{
                position: 'absolute',
                bottom: 0,
                right: 0,
                height: lineSize ? lineSize : 2,
                width: focusedAnim.interpolate({
                  inputRange: [0, 1],
                  outputRange: [0, width],
                }),
                backgroundColor: lineColor ? lineColor : iconColor,
              }}
            />
          ) : (<View
            style={{
